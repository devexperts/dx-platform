...
storiesOf('RenderRemoteData', module)
	...
	.add('error', () => (
		<RenderRemoteData success={renderSuccess} data={DataStateError(new Error('some test error'))} />
	))
	.add('no data', () => (
		<RenderRemoteData success={renderSuccess} data={success('')} DataStateNoDate={data => !!data} />
	));
