	...
	render() {
		...
		return (
			<div className={theme.container}>
				<Input {...restInputProps} theme={theme.Input} isDisabled={isDisabled} type={isRevealed ? 'text' : 'password'}/>
				<Button icon={<Icon/>} theme={theme.RevealButton} isDisabled={isDisabled}
